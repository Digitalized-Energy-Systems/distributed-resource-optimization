...
class TestMergeCandidates:
    def test_merge(self, si, pi, pid_i, perf_i, sj, pj, pid_j, perf_j,
                   own_id, exp_s, exp_pid, exp_perf):
...
class TestSelectionMultiplePerceiveDecide:
    def test_best_schedule_chosen(self):
        cohda = create_cohda_participant(
            1, [[0.0, 1, 2], [1, 2, 3], [1, 1, 1], [4, 2, 3]]
        )
...
S_HINRICHS = [
    ...
    [[13, 12, 12, 12, 12], [15, 15, 15, 14, 14], [18, 17, 17, 17, 17], [20, 20, 20, 19, 19], [23, 22, 22, 22, 22]],
    [[25, 24, 23, 23, 23], [27, 26, 26, 25, 25], [30, 29, 28, 28, 28], [32, 31, 31, 30, 30], [35, 34, 33, 33, 33]],
    [[36, 35, 35, 34, 34], [39, 38, 37, 36, 36], [41, 40, 40, 39, 39], [44, 43, 42, 41, 41], [46, 45, 45, 44, 44]],
    [[48, 47, 46, 45, 45], [50, 49, 48, 48, 47], [53, 52, 51, 50, 50], [55, 54, 53, 53, 52], [58, 57, 56, 55, 55]],
    [[60, 58, 57, 56, 56], [62, 61, 60, 59, 58], [65, 63, 62, 61, 61], [67, 66, 65, 64, 63], [70, 68, 67, 66, 66]],
    [[71, 70, 68, 67, 67], [74, 72, 71, 70, 69], [76, 75, 73, 72, 72], [79, 77, 76, 75, 74], [81, 80, 78, 77, 77]],
    [[83, 81, 80, 78, 78], [85, 83, 82, 81, 80], [88, 86, 85, 83, 83], [90, 88, 87, 86, 85], [93, 91, 90, 88, 88]],
    [[95, 92, 91, 90, 89], [97, 95, 93, 92, 91], [100, 97, 96, 95, 94], [102, 100, 98, 97, 96], [105, 102, 101, 100, 99]],
    [[106, 104, 102, 101, 100], [109, 106, 105, 103, 102], [111, 109, 107, 106, 105], [114, 111, 110, 108, 107], [116, 114, 112, 111, 110]],
]
...
class TestOnExchangeCohdaHinrichs:
    def test_convergence_10_participants(self):
        ...
        last_length = -1
        while last_length == -1 or last_length < len(test_carrier.test_neighbor_messages.get(1, [])):
            for part in parts:
                if last_length != -1:
